...
public class GridTablesGenerator : MonoBehaviour
{
    ...
    //Par d�faut les tables vont se placer au point d'ancrage des tiles, c.a.d. dans le coin inf�rieur gauche. Pour compenser cela on applique un offset de 0.5 en x et y
